...
class Persona(AbstractUser):
    ...
    cedula_identidad = models.IntegerField(
        "Cédula de Identidad", blank=True, null=True, db_index=True
    )
    otros_nombres = models.CharField(
        "Otros Nombres", max_length=90, null=True, blank=True
    )
    otros_apellidos = models.CharField(
        "Otros Apellidos", max_length=255, null=True, blank=True
    )
    telefono = models.CharField("Teléfono Local", max_length=255, blank=True, null=True)
    celular = models.CharField(
        "Teléfono Celular", max_length=255, blank=True, null=True
    )
